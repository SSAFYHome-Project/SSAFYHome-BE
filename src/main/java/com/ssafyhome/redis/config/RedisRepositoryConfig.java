...
public class RedisRepositoryConfig {
    ...
    public RedisTemplate<String, DealInfo> recentViewRedisTemplate() {
        ...
        redisTemplate.setHashValueSerializer(new Jackson2JsonRedisSerializer<>(DealInfo.class));
        redisTemplate.setValueSerializer(new Jackson2JsonRedisSerializer<>(DealInfo.class));
